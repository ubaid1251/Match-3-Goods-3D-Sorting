...
public static class Util
{
	...
	public static bool AttemptGetUnityFolderMonoDLLs(bool wasWebBuild, bool wasAndroidApkBuild, string editorAppContentsPath, ApiCompatibilityLevel monoLevel, ManagedStrippingLevel codeStrippingLevel, out string path, out string higherPriorityPath)
	{
		bool success = false;
		...
		if (!string.IsNullOrEmpty(tryPath))
		{
			...
			if (wasAndroidApkBuild && codeStrippingLevel == ManagedStrippingLevel.Minimal)
			{
