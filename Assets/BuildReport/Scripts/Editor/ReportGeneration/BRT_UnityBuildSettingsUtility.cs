...
namespace BuildReportTool
{
    ...
    public static class UnityBuildSettingsUtility
    {
		...
		settings.ForceOptimizeScriptCompilation = EditorUserBuildSettings.forceOptimizeScriptCompilation;
            ...
            settings.EnableHeadlessMode = true;
		...
		settings.StripPhysicsCode = PlayerSettings.stripPhysics;
            ...
            settings.StrippingLevelUsed = PlayerSettings.GetManagedStrippingLevel(BuildTargetGroup.Android).ToString();
...
#if !UNITY_5_1_AND_LESSER
            settings.EnableVirtualRealitySupport = true;
#endif
		...
		settings.WebGLOptimizationLevel = EditorUserBuildSettings.webGLOptimizationLevel.ToString();
            ...
            settings.WebGLCreateDebugSymbolsFile = PlayerSettings.WebGL.debugSymbolMode == WebGLDebugSymbolMode.Embedded;
		...
		settings.StandaloneFullScreenByDefault = true;
#endif
#if !UNITY_5_2_AND_LESSER
