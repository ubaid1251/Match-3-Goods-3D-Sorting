...
namespace BuildReportTool {
    ...
    public class ReportGenerator {
		...
		buildInfo.MonoLevel = PlayerSettings.apiCompatibilityLevel;
            ...
            buildInfo.CodeStrippingLevel = PlayerSettings.GetManagedStrippingLevel(BuildTargetGroup.Android);
        ...
        static void ParseDLLs(string editorLogPath, bool wasWebBuild, bool wasWebGLBuild, string buildFilePath, string projectAssetsPath, string editorAppContentsPath, ApiCompatibilityLevel monoLevel, ManagedStrippingLevel codeStrippingLevel, out BuildReportTool.SizePart[] systemDLLs, out BuildReportTool.SizePart[] unityEngineDLLs, out BuildReportTool.SizePart[] scriptDLLs) {
